function [hess,err] = hessianest(obj,fun,x0)
% hessian: estimate elements of the Hessian matrix (array of 2nd partials)
% usage: [hess,err] = hessianest(fun,x0)
%
% Hessianest is NOT a tool for frequent use on an expensive
...
%
%  hessianest(@(xy) cos(xy(1)-xy(2)),[0 0])
%  ans =
%           -1            1
%            1           -1
%
...
[grad,graderr,stepsize] = gradest(obj,fun,x0);
